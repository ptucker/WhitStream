        ...
        private void GenerateData(TcpClient tc)
        {
            ...
            while (produceData)
            {
                ...
                if (fPunct)
                {
                    ...
                    WhitStream.Data.Punctuation.LiteralPattern[] rglp = new WhitStream.Data.Punctuation.LiteralPattern[iRow - iRowStart];
                    for (UInt64 iLit = 0; iLit < iRow - iRowStart; iLit++)
                        rglp[iLit] = new WhitStream.Data.Punctuation.LiteralPattern((UInt64) (iLit + iRowStart));
