...
namespace WhitStream.QueryEngine
{
    ...
    public abstract class Query
    {
        ...
        protected int itemsIn = 0, itemsOut = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public virtual int GetItemsReady() { return 0; }
        ...
        public double Selectivity
        {
            ...
            {
                if (itemsIn > 0)
                    return (double)itemsOut / (double)itemsIn;
                else
                    return 1; //we can't really know for sure
            }
        }
    ...
    public abstract class UnaryOp : Query
    {
        ...
        public delegate DataItem Relation(DataItem di, RelationTable rt);
    ...
    public abstract class BinaryOp : Query
    {
        ...
        public override int GetItemsReady()
        {
            return (opInLeft.GetItemsReady() + opInRight.GetItemsReady());
        }
